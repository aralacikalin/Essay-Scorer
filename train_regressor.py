...
tokenizedDataset = trainSet.map(lambda examples: tokenizer(examples['essay'],truncation=True,padding=True))
...
tokenizedDataset = testSet.map(lambda examples: tokenizer(examples['essay'],truncation=True,padding=True))
# tokenizedDataset = dataset.map(lambda examples: tokenizer(examples['essay'],truncation=True,padding=True), batched=True)
print(tokenizedDataset.features)
